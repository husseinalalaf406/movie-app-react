...
const resources = {
  en: {
    translation: {
      ...
      playOfficialTrailer: "Play Official Trailer",
      ...
      closeTrailerClean: "Close Trailer",
  ...
  ar: {
    translation: {
      ...
      playOfficialTrailer: "تشغيل العرض الرسمي",
      previewBadge: "معاينة",
      muteAudio: "كتم الصوت",
      unmuteAudio: "تشغيل الصوت",
      pausePreview: "إيقاف مؤقت",
      playPreview: "تشغيل العرض",
      replayPreview: "إعادة تشغيل العرض",
      loadingTrailer: "جاري تحميل العرض...",
      closeTrailerClean: "إغلاق العرض",
